    ...
    public GUI07220() {
        ...
        check.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (ceklogin == true) {
                    try {
                        Allobjctrl07220.admin.dataAslab();
                        Allobjctrl07220.admin.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = Allobjctrl07220.admin.aslabEntity07220().getNama();
                        JOptionPane.showMessageDialog(null, "selamat datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        AslabGUI07220 asisten = new AslabGUI07220();
                        LogReg.dispose();
                    ...
                    try {
                        Allobjctrl07220.Praktikan.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = Allobjctrl07220.Praktikan.PraktikanEntity().getNama();
                        JOptionPane.showMessageDialog(null, "Selamat Datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        PraktikanGUI07220 prak = new PraktikanGUI07220();
                        LogReg.dispose();
                    } catch (Exception exception) {
        ...
        reg.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    Allobjctrl07220.Praktikan.insert(npm, pass, nama, notelp, tgllahir, kelas);
